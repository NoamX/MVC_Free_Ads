...
<div class="col">
    <div class="card" style="margin: 0 75px">
        <div class="card-header">
            <a href="/ad"><button class="btn btn-primary">Back</button></a>
            <hr>
            <h3 class="card-title">Create an ad</h3>
        </div>
        <div class="card-body">
            {{ Form::open([ 'url' => '/ad/create', 'method' => 'post']) }}
            <input class="form-control" type="text" name="title" placeholder="Title" required><br>
            <input class="form-control" type="number" step="0.01" name="price" placeholder="Price" required><br>
